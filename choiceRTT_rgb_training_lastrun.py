...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\charl\\Desktop\\ter-experience\\psychopy\\choiceRTT_rgb_training_lastrun.py',
