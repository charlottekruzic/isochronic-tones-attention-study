...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\charl\\OneDrive\\Desktop\\no-onedrive\\isochronic-tones-attention-study\\experiment\\choiceRTT_rgb_main_lastrun.py',
...
def run(expInfo, thisExp, win, inputs, globalClock=None, thisSession=None):
    ...
    instr_2 = visual.TextStim(win=win, name='instr_2',
        text='Appuyer sur une touche pour démarrer la phase 1.',
        font='Arial',
        units='height', pos=(0, 0.1), height=0.035, wrapWidth=None, ori=0, 
        color='black', colorSpace='rgb', opacity=1, 
        languageStyle='LTR',
    ...
    instr_3 = visual.TextStim(win=win, name='instr_3',
        text='Bravo, la phase 1 est terminée !\n\nAppuyer sur une touche pour démarrer la phase 2.',
        font='Arial',
        units='height', pos=(0, 0.1), height=0.035, wrapWidth=None, ori=0, 
        color='black', colorSpace='rgb', opacity=1, 
        languageStyle='LTR',
    ...
    instr_4 = visual.TextStim(win=win, name='instr_4',
        text='Bravo, la phase 2 est terminée !\n\nAppuyer sur une touche pour démarrer la phase 3.',
        font='Arial',
        units='height', pos=(0, 0.1), height=0.035, wrapWidth=None, ori=0, 
        color='black', colorSpace='rgb', opacity=1, 
        languageStyle='LTR',
    ...
    ExptLoop1 = data.TrialHandler(nReps=50.0, method='random', 
    ...
    # completed 50.0 repeats of 'ExptLoop1'
    ...
    # set up handler to look after randomisation of conditions etc
    ExptLoop2 = data.TrialHandler(nReps=50.0, method='random', 
        extraInfo=expInfo, originPath=-1,
        trialList=data.importConditions('RTtimeConditions_main.xlsx'),
    ...
    for thisExptLoop2 in ExptLoop2:
        ...
        if thisSession is not None:
            # if running in a Session with a Liaison client, send data up to now
            thisSession.sendExperimentData()
    # completed 50.0 repeats of 'ExptLoop2'
    ...
    # set up handler to look after randomisation of conditions etc
    ExptLoop3 = data.TrialHandler(nReps=50.0, method='random', 
        extraInfo=expInfo, originPath=-1,
        trialList=data.importConditions('RTtimeConditions_main.xlsx'),
    ...
    for thisExptLoop3 in ExptLoop3:
        ...
        if thisSession is not None:
            # if running in a Session with a Liaison client, send data up to now
            thisSession.sendExperimentData()
    # completed 50.0 repeats of 'ExptLoop3'
